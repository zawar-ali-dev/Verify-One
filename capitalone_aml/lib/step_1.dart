        ...
        body: Stack(
          ...
          children:  [
            ...
            Container(
              ...
              child: const Text ('Select a clear photo of your UK Driving licence. The image captured will be displayed in the space below',
                style: TextStyle(
                  fontSize: 16,
                  color: Color.fromRGBO(255, 255, 255, 1),
                ),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: ()  {
                          ...
                          CupertinoActionSheetAction(
                              onPressed: () async {
                                ...
                                if (pickedFile == null) {
                                  ...
                                  MaterialPageRoute(builder: (context)=>step1approval(File(pickedFile.path), jsonData)
                                  ));
                                }
                              },
                  ...
                  // } else {
                  //   Navigator.push(context,
                  //   MaterialPageRoute(builder: (context)=>step1approval(File(pickedFile.path))
                  //   ));
                  // }
                },
              ),
